...
{July}
{fr}
Digital games are getting better and demanding more complexity, bringing more
aggregated content. The time spended to produce this content requires a lot of
work effort. With the intention of assisting in this difficulties,
the procedural generation of content can generate graphics with less or no user
effort. In this paper we will evaluate some characteristics such as plains and
mountain ranges, and implement an algorithm not assisted, that procedurally
forms the terrain with this characteristics, in the occurrence of biomes borders
with distinct terrain, it will be continuous. At the end, a visual judgment on
the results will be made comparing characteristics found in nature and other games.
The size of the map must be pseudo infinite and only load regions close to the
camera.
