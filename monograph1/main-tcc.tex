...
\begin{abstract}
    ...
    os mesmos, trazendo mais conteúdo agregado. Tempo para produzir este conteúdo
    ...
    de relevo, como planícies e cordilheiras, e implementado um algoritmo não 
    assistido que forme proceduralmente o relevo destas características, na ocorrência
...
%A indústria de jogos digitais 3D vem crescendo e melhorando seus conteúdos nos últi-
%mos anos, tornando-os cada vez mais realistas. Essas indústrias também enfrentam o problema
%de tempo de desenvolvimento e alto custo para produzir esses conteúdos. A fim de solucio-
%nar essas dificuldades, a geração procedural de conteúdos gráficos permite que, sem ou com
%mínima intervenção do usuário, sejam produzidas quaisquer tipos de objetos, terrenos, mapas,
%entre outros. Nesse trabalho é apresentada uma proposta de algoritmo procedural que gera câ-
%nions baseado em ruído de Perlin, que contribui, para o estudo de geração procedural específica
%para terrenos naturais. O algoritmo é limitado em quatro características analisadas como mais
%recorrentes em cânions reais: topo plano, níveis penhasco, sopé suavizado e penhasco íngreme.
%Além disso é sugerida uma solução para a aparência de quinas na lateral dos cânions gerados
%pelo algoritmo de Carli (CARLI, 2012) e para a suavização do sopé, que no algoritmo de Carli
%é necessária um tratamento especial para a criação desse efeito. É feito um julgamento visual
%subjetivo das imagens geradas pelo algoritmo proposto e avalia a presença das características
%selecionadas, assim como as limitações do algoritmo.
...
\input{capitulos/revisaobibliografica}
