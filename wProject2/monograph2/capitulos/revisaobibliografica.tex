...
A função de ruído usa interpolação de pontos aletários para determinar seu resultado.
...
figura \ref{fig:randomAndNoise}, tendo o ($x$) na horizontale ($y$) na vertical.
\begin{figure}[H]
    \centering
