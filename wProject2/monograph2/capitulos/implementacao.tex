...
\begin{table}[H]
    ...
    \begin{tabular}{| c | c c c c c|}
        \hline
        $biomaTipo$ & $f$ & $\theta$ & $minColor'$ & $midColor'$ & $maxColor'$\\
        \hline
        Planícies   & $10$ & $4$ & $(34, 139, 34) $ & $(154, 205, 50) $ & $(143,188,143)  $  \\
        Montanhas & $18$ & $8$ & $(128, 128, 0) $ & $(112, 128, 144)$ & $(255, 255, 255)$  \\
        Vales   & $8$  & $8$ & $(30, 144, 255)$ & $(46, 139, 87)  $ & $(34, 139, 34)  $  \\
        Deserto   & $6$  & $2$ & $(0, 0, 0)     $ & $(244, 164, 96) $ & $(255, 255, 255)$  \\
...
\begin{algorithm}[H]\label{alg:hBioValuation}
    ...
    \Else{
        \tcc{Cânyons}
        h = $(1.5^{clamp(h', -0.3, 0.3) \cdot 14}) \cdot 5 + h' * 8$\;
    }
...
DEBUG: aqui eu comento as limitações?