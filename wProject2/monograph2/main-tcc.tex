...
{July}
{fr}
    The larger the scenario of a game, more time the player will spend to exploit it.
    Traditionally, this demand is met through a large graphic design team.
    This work details a technique able to procedurally generate a terrain pseudo infinite with 5 visually distinct biomes,
    spreading them in regions and smooth their borders.
    The area, frequency, adjacency and smoothness of the biomes can be adjusted
    through parameters.
    The result is a terrain generator suited for computer games development.
\end{englishabstract}
