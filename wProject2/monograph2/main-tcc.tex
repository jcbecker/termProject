...
\begin{abstract}
    ...
    ou nenhum esforço do usuário. 
    Neste trabalho é apresentada uma técnica capaz de gerar proceduralmente 5 
    biomas visualmente distintos, distribuí-los em regiões e suavizar suas fronteiras.
    O resultado é um terreno adequado para uso em jogos de computador.
...
This work detais a technique able to procedually generate 5 visually distinct biomes,
spreading them in regions and smooth their borders.
The result is a terrain suited for computer games.
\end{englishabstract}
